export const siteIdentity = {
  ...
  tagline: process.env.NEXT_PUBLIC_SITE_TAGLINE || 'Media press wire network',
  description:
    process.env.NEXT_PUBLIC_SITE_DESCRIPTION ||
    'Top24Headline is a media distribution platform for press wires, newsroom announcements, and digital publisher reach.',
